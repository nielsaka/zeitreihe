...
#'   columns will be equal to `Y0`. Column `p + 1` will be equal to `A %*% Y0 +
#'   U[, 1]`, where `U` contains reduced form errors. The final observation of
#'   the `K` variables will be in column `N`.
